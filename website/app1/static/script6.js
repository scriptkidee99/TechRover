...
$(document).ready(function(){
    $('#confirmPasswordBox').on('keypress',function(e){
        if(e.which == 13)
        {
            $('#signUpButton').click();
        }
...
$(document).ready(function(){
    var uts = $('#userState').text();
    if (uts == 'notFound') alert("User not found. Sign Up");
    else if (uts == "mismatch") alert("Username password mismatch");
    else if(uts == "exist") alert("User already exists. Try logging in");
})